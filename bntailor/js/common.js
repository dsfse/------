$(document).ready(function(){
    /*
        ...
        $(window).scroll() -- 브라우저 스크롤 될때마다 실행
        
        1. 브라우저가 스크롤이 되면 header에 클래스를 추가 
    ...
    */
    ...
    /* 
        모바일 메뉴 열기 
        .header .gnb .gnb_open을 클릭했을때
        1. .header .gnb한테 mobile_open 클래스를 추가하거나 삭제
            (닫는 버튼과 여는 버튼 두거지 역할을 모두 함)
        2. header .gnb .gnb_open strong에 쓰여있는 글자를 메뉴열기, 메뉴닫기로 변경
